...
describe('User API', function() {
  ...
  describe('GET /api/users', function() {
    it('routes admins to controller.index', function() {
      expect(
  ...
  describe('POST /api/users', function() {
    it('routes to controller.create', function() {
      expect(
  ...
  describe('GET /api/users/me', function() {
    it('routes authenticated users to controller.me', function() {
      expect(
  ...
  describe('PUT /api/users/:id/password', function() {
    it('routes authenticated users to controller.update', function() {
      expect(
  ...
  describe('GET /api/users/:id', function() {
    it('routes authenticated users to controller.show', function() {
      expect(
  ...
  describe('DELETE /api/users/:id', function() {
    it('routes authenticated users to controller.remove', function() {
      expect(
